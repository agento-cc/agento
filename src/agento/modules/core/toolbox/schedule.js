...
export function register(server, { log, db, isToolEnabled }) {
  ...
  server.tool(
    ...
    [
      ...
      'The source parameter identifies the communication channel (e.g. "jira", "outlook", "teams").',
      'Examples:',
      '  reference_id: "AI-123", source: "jira", scheduled_at: "2026-02-24T16:30:00", instructions: "Sprawdź czy reindeks się zakończył..."',
      '  reference_id: "msg-abc", source: "outlook", scheduled_at: "2026-02-25T08:00:00", instructions: "Sprawdź odpowiedź..."',
    ].join('\n'),
    {
      ...
      source:        z.string().optional().default('jira').describe('Communication channel: "jira", "outlook", "teams"'),
